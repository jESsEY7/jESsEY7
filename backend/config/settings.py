...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 12, # Adjusted for grid layout (e.g., 3 or 4 columns)
...
if DEBUG:
    ...
    cors_origins = os.environ.get('CORS_ALLOWED_ORIGINS', 'http://localhost:5173,http://localhost:5174,http://127.0.0.1:5173,http://127.0.0.1:5174')
...
# VIN lookup provider configuration
VIN_PROVIDER = os.environ.get('VIN_PROVIDER', 'apps.vehicles.services.NHTSAProvider')
VIN_CACHE_DAYS = int(os.environ.get('VIN_CACHE_DAYS', '30'))

WHATSAPP_COMMUNITY_URL = os.environ.get('WHATSAPP_COMMUNITY_URL', 'https://chat.whatsapp.com/your-invite-code')
